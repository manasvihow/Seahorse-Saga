window.addEventListener("load", function(){
    ...
    class Particle {
        ...
        draw(context){
            ...
            context.drawImage(this.image, this.frameX + this.spriteSize, this.frameX + this.spriteSize, this.spriteSize, this.spriteSize, this.size * -0.5, this.size * -0.5, this.size, this.size);
            context.restore();
        }
    ...
    class UI {
        ...
        draw(context){
            ...
            if (this.game.gameOver){
                ...
                let message1 = "Score: " + this.game.score;
                
                context.font = "150px " + this.fontFamily;
                context.fillText(message1, this.game.width * 0.5, this.game.height * 0.5 - 60);
            ...
            if(this.start){
                ...
                this.enemies.forEach(enemy => {
                    ...
                    if (this.checkCollision(this.player, enemy)){
                        if (enemy.type != 'lucky') this.gameOver = true;
                ...
                if (!this.gameOver && this.ammoTimer > this.ammoInterval){
